        ...
        <div class="col-10 col-md-6" id="editable__info">
                    ...
                    >
                        ...
                        <div class="col-md-12">
                            <label for="username" class="form-label"
                                >username must be over 6 characters and
                                unique</label
                            >
                            <input
                                type="text"
                    ...
                    >
                        ...
                        <div class="col-md-12">
                            <label for="dob" class="form-label"
                                >ensure that you are over 18</label
                            >
                            <input
                                type="date"
                                class="form-control"
                    ...
                    >
                        ...
                        <div class="row">
                            <label for="address" class="form-label mt-3"
                                >your address will be use when making a
                                purchase</label
                            >
            ...
            <section id="idcard__section">
                <div class="info__container">
                    ...
                    <img
                        src="/img/user/{{ auth()->id() . '/id_card/' . auth()->user()->id_card}}"
                        alt="id"
                        width="100%"
                        height="100px"
                    />
            ...
            <section id="profile__section">
                <div class="info__container">
                    ...
                    <img
                        src="{{ 'img/user/' . auth()->id() . '/profile/' . auth()->user()->profile}}"
                        alt="profile"
                        height="100px"
                    />
                </div>
            ...
            <section id="remove__section">
                <form
                    class="ms-auto"
                    id="removed"
                    action="{{route('profile.destroy', auth()->user())}}"
                    method="POST"
                >
                    @method('DELETE')
                    @csrf
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button
                                        type="button"
                                        class="btn btn-danger"
                                        onclick="document.getElementById('removed').submit();"
                                    >
                                        Delete
                                    </button>
                                </div>
