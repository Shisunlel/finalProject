...
<html lang="en">
  <head>
    ...
    <link
      href="https://fonts.googleapis.com/css2?family=Nunito:wght@300;400;600;700&family=Poppins:wght@300;400;600&display=swap"
      rel="stylesheet"
    />
    ...
    <div class="container-fluid m-0 p-0">
        ...
        <div class="container">
          ...
          >
            <button
              ...
              type="button"
              data-bs-toggle="collapse" data-bs-target="#collapseNav" aria-controls="collapseNav" aria-expanded="false" aria-label="Toggle navigation"
            >
            ...
            <div class="row">
              ...
              >
                ...
                <p class="text-center text-md-left small">
                  Enjoy the comforts of an affordable rental, with the peace of
      ...
      <div class="container mt-5 fade-in">
        <section id="services" class="text-center mb-5">
          ...
          <p class="small">
            When it comes to real estate and properties, we're here all the way.
          </p>
        </section>
            ...
            <div class="card align-items-center">
              <span class="card-animation">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">
                    You'll only pay one fee,and it's fixed from the beginning.
                    There are no surprise, and we never add commission.
                  </p>
                </div>
              </span>
            </div>
            <div class="card align-items-center">
              <span class="card-animation">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">
                    Your dedicated local estate and their team of property
                    experts will be with you every step until your home is sold.
                  </p>
                </div>
              </span>
            </div>
            <div class="card align-items-center">
              <span class="card-animation">
                ...
                <div class="card-body text-center">
                  ...
                  <p class="card-text">
                    Our partner can help with mortgages and conveyancing, and
                    every homeowner gets free utilities switching services.
                  </p>
                </div>
              </span>
            </div>
      ...
      <div class="container-fluid bg-dark-shade fade-in" id="features">
        <div class="container text-light py-5">
          <section id="features-title" class="text-center">
            <h1 class="font-weight-bold text-uppercase">Features</h1>
            <p class="small">
              Here's why our service is <em>FAR</em> differ from our competitor.
            </p>
          </section>
            ...
            <div class="row p-3">
              <div class="col-12 col-md-6 my-4">
                <div class="row align-items-center justify-content-center">
                  <figure class="col-4 col-md-5 features-logo text-center">
                    <i class="fas fa-tachometer-alt fa-3x text-danger"></i>
                  </figure>
                  <div class="text-container col-8 col-md-7 text-left">
                    <h5>High Speed Internet</h5>
                    <p class="small">
                      With our high speed internet technology, you won't ever
                      lag behind or miss an important date again.
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-6 my-4">
                <div class="row align-items-center justify-content-center">
                  ...
                  >
                    ...
                    <p class="small">
                      Our app comes with a backdoor security as well as 2-Auth
                      password so you won't have to deal with insecurity of your
                      account. <br />
                      We don't sell your data like some shh big company
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-12 col-md-6 my-4">
                <div class="row align-items-center justify-content-center">
                  <figure class="col-4 col-md-5 features-logo text-center">
                    <i class="far fa-comment-dots fa-3x text-success"></i>
                  </figure>
                  <div class="text-container col-8 col-md-7 text-left">
                    <h5>Instant Reply</h5>
                    <p class="small">
                      Do not worry, we won't left you on read. Our 24/7 support
                      will be with you every step of the way including hangover
                      talks.
                    </p>
                  </div>
                </div>
              ...
              <div class="col-12 col-md-6 my-4">
                <div class="row align-items-center justify-content-center">
                  <figure
                    class="col-4 col-md-5 features-logo text-center order-2"
                  >
                    <i class="fas fa-hand-sparkles fa-3x text-skin"></i>
                  </figure>
                  <div
                    class="text-container col-8 col-md-7 text-right order-md-2"
                  >
                    <h5>Hygene</h5>
                    <p class="small">
                      Taking care of our dear customers is always our priority
                      so every time our customers check out and in. we make sure
                      that the rooms are always kept clean because we are not a
                      lazybones.
                    </p>
                  </div>
                </div>
      ...
      >
        <div class="container">
          <section id="about">
            <h1 class="font-weight-bold text-uppercase text-uppercase">
              About Us
            </h1>
            <p class="small">Our mastermind behind this amazing app</p>
          </section>
          <section id="team">
            <div class="row">
              <div
              ...
              >
                ...
                <div class="text-content">
                  <h5 class="font-weight-bold">
                    <a href="https://www.github.com/shisunlel" target="_blank">
                      Vutha Vyrapol
                    </a>
                  </h5>
                  <p class="text-info small font-weight-light">Web Developer</p>
                </div>
              </div>
              <div
                class="col-12 col-sm-6 col-md-6 col-lg-3 d-flex flex-column align-items-center"
              >
                ...
                <div class="text-content">
                  ...
                  <p class="text-info small font-weight-light">
                    Software Developer
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div class="text-content">
                  <h5 class="font-weight-bold">San Vuthdimong</h5>
                  <p class="text-info small font-weight-light">
                    Graphic Designer
                  </p>
                </div>
          ...
          <div class="col-12 col-md-4 mt-2 mb-2">
            <section class="host-footer">
              ...
              <ul class="navbar-nav">
                ...
                >
                <a href="#" class="mb-1"
                  ><li class="nav-item">Guideline and Policy</li></a
                >
        ...
        <div id="footer-container" class="container-lg">
          <div class="row" id="footer-cp">
            ...
            >
              ...
              <span>
                <ul class="d-flex flex-row m-0 mt-3 mt-md-0 p-0">
                  ...
                  <li class="nav-item social-link">
                    <a
                      href="https://www.twitter.com/xqc"
                      target="_blank"
                      class="me-4"
