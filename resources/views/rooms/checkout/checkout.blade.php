    ...
    <div class="container wow fadeIn">
        ...
        <div class="row">
                    ...
                    >
                        ...
                        <div class="md-form mb-3">
                            ...
                            <input
                                ...
                                hidden
                            />
                            <input type="number" name="total" value="{{sprintf("%.2f", $request->cost + ($request->service * ($request->duration / 15)))
                            }}" hidden>
                        </div>
                        <div class="md-form">
                        ...
                        <div class="md-form row mt-2 mb-4">
                            @if (!empty(auth()->user()->housenumber ||
                            auth()->user()->street || auth()->user()->district
                            || auth()->user()->commune ||
                            auth()->user()->province))
                            <span>
                                # {{auth()->user()->housenumber}}, Street
                                {{auth()->user()->street}}, Khan
                                {{auth()->user()->district}}, Sangkat
                                {{auth()->user()->commune}},
                                {{auth()->user()->provice}}
                            </span>
                            @else
                        ...
                        <div class="md-form mt-2">
                            ...
                            <div class="justify-content-between d-flex">
                                @if (Str::contains(auth()->user()->phone_number,
                                '0'))
                                <small
                                    class="form-label"
                                ...
                                <small class="form-label"
                                    >Add and confirm your phone number to get
                                    updated</small
                                >
                                <div class="info__container hidden my-2">
                                    <small class="form-label"
                                        >Phone number should always start with
                                        0</small
                                    >
                                    <input
                                        type="text"
                        ...
                        @endif @if (empty(auth()->user()->id_card))
                        <div class="md-form mt-2">
                            <h6 class="fw-bold">Identification Card</h6>
                            <div class="justify-content-between d-flex">
                                <small class="form-label">
                                    Host would like to know who will be staying
                                    at their place
                                </small>
                                <div class="info__container hidden my-2">
                                    <input
                        ...
                        <div class="md-form mb-3">
                            ...
                            @if (Str::contains(auth()->user()->profile, ['.jpg',
                            '.webp', '.svg', '.png', '.jpeg']))
                            <div class="d-flex justify-content-center">
                                <img
                                    src="@if (Str::length(auth()->user()->profile) > 11)
                            ...
                            <div class="d-flex justify-content-between">
                                <small class="form-label"
                                    >Hosts want to know who will be staying at
                                    their place</small
                                >
                                <div class="info__container hidden my-2">
                                    <input
                        ...
                        <section class="💳">
                            <button
                                ...
                                type="submit"
                                onclick="return preventUnderage();"
                            >
                                Proceed to checkout
                            </button>
            ...
            <div class="col-lg-4 order-1">
                <!-- Heading -->
                <h4
                    class="d-flex d-md-block d-lg-flex justify-content-between align-items-center mb-3"
                >
                ...
                <ul class="list-group mb-3 z-depth-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-center">
                                <div>
                                    <small
                                        class="text-muted"
                                        >{{Str::limit($room->address, 15)}}</small
                                    >
                                </div>
                                <div>
                                    <p class="fw-bold">
                                        {{Str::limit($room->title, 15)}}
                                    </p>
                                </div>
                                <div>
                                    <small
                                        class="text-muted"
                                        >{{Str::limit($room->description, 15)}}</small
                                    >
                                </div>
                                @php 
                                  $total = 0; 
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            <span
                                >${{$room->price}} x {{$request->duration}}
                                {{Str::plural('day', $request->duration)}}</span
                            >
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <label class="form-label"
                                >${{sprintf("%.2f",$request->service)
                                }}<sub>/15 days</sub></label
                            >
                        </div>
                        <div class="d-flex justify-content-between mt-4">
                            <span class="fw-bold">Total (USD)</span>
                            <p class="fw-bold">
                                ${{sprintf("%.2f", $request->cost + ($request->service * ($request->duration / 15)))}}
                            </p>
                        </div>
                    </li>
                </ul>
